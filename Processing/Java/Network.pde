int rand = int(random(100, 300));
int num = rand; // amount of nodes in the network
void setup() {
 size (800, 800);
 background(255);
 ...
 int opacityrand = int(random(4,12));
 stroke(col,col1,col2, opacityrand); // setting transparency to 10
 noLoop();
}
void draw() {
